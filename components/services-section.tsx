...
export function ServicesSection() {
  const services = [
    {
      ...
      description:
        "Deep dive into your data with our comprehensive analytics platform powered by AI algorithms.",
    ...
    },
    {
      ...
      title: "AI Solutions",
      description:
        "AI can streamline operations, automate tasks, analyze data for insights, personalize customer experiences, improve decision-making, enhance cybersecurity, and drive innovation, ultimately boosting efficiency and competitiveness for a company.",
    ...
    },
    {
      ...
      description:
        "Seamlessly integrate all your data sources into a unified analytics platform.",
      variant: "primary" as const,
    ...
    },
    {
      ...
      description:
        "Process and analyze data in real-time for immediate insights and faster action.",
      variant: "secondary" as const,
  ...
  return (
    <section className="pt-20 snap-start snap-always min-h-screen bg-white">
          ...
          {services.map((service, index) => {
            ...
            return (
              <motion.div
                ...
                className={`
                  group relative p-6 md:p-8 rounded-2xl transition-all duration-300 shadow-lg hover:shadow-xl overflow-hidden h-72 md:h-80 lg:h-[320px]
                  ${isPrimary 
              ...
              >
                ...
                <div className="relative z-10 transition-all duration-300 group-hover:blur-sm h-full flex flex-col">
                  {/* Icon */}
                  <div className={`
                    w-12 h-12 md:w-16 md:h-16 rounded-xl md:rounded-2xl flex items-center justify-center mb-4 md:mb-6 flex-shrink-0
                  ...
                  {/* Description */}
                  <p className={`
                    text-xs md:text-sm leading-relaxed flex-grow

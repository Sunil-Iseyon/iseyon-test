  ...
  const servicesMegaMenu = [
    {
      ...
      items: [
        ...
        { label: 'Snowflake', href: '/services/cloud-and-platforms/snowflake' },
        { label: 'Databricks', href: '/services/cloud-and-platforms/databricks' },
      ]
    },
    {
      group: 'BI & Analytics',
      items: [
        ...
        { label: 'Tableau', href: '/services/bi-and-analytics/tableau' },
        { label: 'MicroStrategy', href: '/services/bi-and-analytics/microstrategy' },
      ]
    },
    {
      group: 'Data & Engineering',
      items: [
        { label: 'SQL Server', href: '/services/data-and-engineering/sql-server' },
        { label: 'Big Data Consulting', href: '/services/data-and-engineering/big-data-consulting' },
        { label: 'Data Management Consulting', href: '/services/data-and-engineering/data-management-consulting' },
        { label: 'Cloud', href: '/services/data-and-engineering/cloud' },
      ]
    },
    {
      group: 'Support',
      items: [
        { label: 'Support & Training', href: '/services/support/support-training' },
      ]
    },
  ]
  ...
  return (
    <header className={` fixed top-0 z-50 w-full transition-all duration-700 ease-in-out ${
      ...
      <nav className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 h-16 md:h-20 flex items-center justify-between">
        {/* Logo - Left */}
        <Link href="/" className="flex items-center gap-2 font-bold text-lg md:text-xl text-primary z-10 flex-shrink-0">
        ...
        <div className={`hidden lg:flex items-center gap-6 xl:gap-8 absolute left-1/2 -translate-x-1/2 px-6 xl:px-8 py-2 md:py-3 rounded-full transition-all duration-700 ease-in-out ${
          ...
          <div
            ...
            onMouseEnter={() => {
              ...
              setHoveredGroup(servicesMegaMenu[0].group)
            }}
            onMouseLeave={() => {
                          ...
                          {hoveredGroup && (
                            ...
                            >
                              ...
                              <div className="space-y-1">
                                {servicesMegaMenu.find(s => s.group === hoveredGroup)?.items.map((item) => (
                                  <Link
                                    key={item.label}
                                    href={item.href}
          ...
          <Link href="/vision" className={`font-medium transition-all duration-300 ${getLinkStyles()}`}>
            Our Vision
          </Link>

          <Link href="/team" className={`font-medium transition-all duration-300 ${getLinkStyles()}`}>
            Our Team
          </Link>
          ...
          <Link href="/blog" className={`font-medium transition-all duration-300 ${getLinkStyles()}`}>
            Blog
          </Link>
        </div>
        ...
        <div className="hidden md:block z-10 flex-shrink-0">
          <Link
            href="/contact"
            className="px-4 md:px-6 py-2 bg-primary text-primary-foreground rounded-lg hover:bg-primary/90 transition-all duration-300 font-medium text-sm md:text-base shadow-lg hover:shadow-xl"
          >
            Contact Us
          </Link>
        </div>

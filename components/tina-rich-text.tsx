      ...
      <div className={className}>
        <ReactMarkdown
          components={{
            ...
            h4: ({ children }) => <h2 className="text-xl font-semibold mb-3">{children}</h2>,
            h5: ({ children }) => <h3 className="text-lg font-semibold mb-2">{children}</h3>,
            h6: ({ children }) => <h4 className="text-base font-semibold mb-2">{children}</h4>,

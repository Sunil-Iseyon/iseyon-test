  ...
  const stats = [
    {
      ...
      source: 'Gartner 2025',
      link: 'https://www.gartner.com/en/newsroom/press-releases/2025-01-ai-analytics',
    },
    {
      icon: Users,
      value: '$274B',
      label: 'global business intelligence market by 2028',
      source: 'Fortune Business Insights',
      link: 'https://www.fortunebusinessinsights.com/business-intelligence-market',
    },
    {
      icon: Award,
      value: '5.6x',
      label: 'ROI achieved through data-driven decision making',
      source: 'MIT Sloan Management Review',
      link: 'https://sloanreview.mit.edu/data-analytics',
    },
    {
      icon: CheckCircle2,
      value: '91%',
      label: 'of leading organizations invest in AI initiatives',
...
export function  ExpertQuotes() {
  const quotes = [
    {
      quote: "Data is the new oil, but analytics is the combustion engine that powers business transformation.",
      author: "Dr. Thomas H. Davenport",
      title: "Distinguished Professor, Babson College",
      expertise: "Analytics & AI Research",
      source: "Harvard Business Review",
      link: "https://hbr.org/data-analytics",
    },
    {
      quote: "Organizations that embrace AI-powered analytics are 2.6 times more likely to outperform their peers in revenue growth.",
      author: "Dr. Ajay Agrawal",
      title: "Professor of Strategic Management, University of Toronto",
      expertise: "AI Economics",
      source: "MIT Sloan Management Review",
      link: "https://sloanreview.mit.edu",
    },
    {
      quote: "The future of business intelligence lies in predictive and prescriptive analytics that transform raw data into strategic foresight.",
      author: "Rita Sallam",
      title: "VP Analyst, Gartner",
      expertise: "Analytics & BI",
      source: "Gartner Research",
      link: "https://www.gartner.com/en/research",
    },
  ]
...
export function AuthoritativeCitations() {
  const citations = [
    {
      title: 'Gartner Magic Quadrant for Analytics and BI Platforms 2025',
      organization: 'Gartner Research',
      type: '.com (Industry Authority)',
      link: 'https://www.gartner.com/en/documents/magic-quadrant',
      description: 'Comprehensive evaluation of leading BI platforms and market positioning.',
    },
    {
      title: 'The State of Data Science and Machine Learning 2025',
      organization: 'MIT Sloan Management Review',
      type: '.edu (Academic Research)',
      link: 'https://sloanreview.mit.edu',
      description: 'Academic research on AI adoption in enterprise environments.',
    },
    {
      title: 'AI Adoption and Business Value Survey',
      organization: 'McKinsey & Company',
      type: '.com (Consulting Authority)',
      link: 'https://www.mckinsey.com/capabilities/quantumblack',
      description: 'Global survey on AI implementation and ROI across industries.',
    },
    {
      title: 'Business Intelligence Market Research Report',
      organization: 'Fortune Business Insights',
      type: '.com (Market Research)',
      link: 'https://www.fortunebusinessinsights.com',
      description: 'Comprehensive market analysis and growth projections for BI industry.',
    },
  ]

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          {[
            ...
            <motion.div
              key={idx}
              className="relative p-8 rounded-xl bg-gradient-to-br from-blue-50 via-cyan-50 to-slate-100 border border-blue-200 text-center overflow-hidden shadow-lg"
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p className="text-foreground/70 font-semibold text-sm uppercase tracking-wide">{stat.label}</p>
              </div>
            </motion.div>
          ))}
        </motion.div>

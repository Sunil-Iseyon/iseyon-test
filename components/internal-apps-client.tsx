...
import { ArrowRight, Cog, Database, Activity, Layers, ArrowLeft, Check, Zap, LucideIcon } from 'lucide-react'
...
export function InternalAppsClient({ data }: { data: InternalAppsData }) {

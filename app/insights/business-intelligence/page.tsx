...
import { ArrowRight, BarChart3, TrendingUp, PieChart, Target, ArrowLeft, Zap, Database, Brain } from 'lucide-react'
import bi from '@/public/bi-insights.png'
  ...
  const coreCapabilities = [
    {
      ...
      description: 'Real-time dashboards with custom KPI visualization',
      stats: '500+ Templates'
    },
    {
      icon: TrendingUp,
    ...
    },
    {
      ...
      description: 'Automated insight generation and reporting',
      stats: '80% Faster'
    },
    {
      icon: Zap,
  ...
  const useCases = [
    {
      ...
      description: 'Real-time financial analytics, budget forecasting, and spend optimization',
      icon: Database
    },
    {
      title: 'Sales & Marketing',
      description: 'Pipeline analytics, customer journey tracking, and ROI measurement',
      icon: Target
    },
    {
      title: 'Operations',
      description: 'Process efficiency metrics, supply chain visibility, and performance monitoring',
      icon: Brain
    }
  ]
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-foreground/70 leading-relaxed mb-8 max-w-2xl">
              Business Intelligence that goes beyond dashboards. Discover insights, predict trends, and make confident decisions backed by data.
            </p>
